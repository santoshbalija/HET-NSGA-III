...
This module provides a comprehensive set of entries for benchmarking global
...
The range of entries is extensive, with a range of difficulty. The entries are
multivariate, with N=2 to N=17 provided.

References
----------
.. [1] Momin Jamil and Xin-She Yang, A literature survey of benchmark
    functions for global optimization entries, Int. Journal of Mathematical
