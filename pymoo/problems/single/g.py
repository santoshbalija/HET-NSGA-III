...
class G10m(G):
    ...
    def _evaluate(self, x, out, *args, **kwargs):
        ...
        # Normalization scales (chosen from constants or estimated bounds)
        s1 = 1.0       # already small
        s2 = 1.0
        s3 = 1.0
        s4 = 83333.333   # scale based on constant term
        s5 = 11137500.0   # scale based on coefficient magnitude 1250.0 or alternative based variable bounds
        # gmax,gmin
        s6 = 1250000.0  # scale based on constant term
