...
from  pyheterogeneous.algorithms.he_rho_generalized_cons_first_block import HECFB
...
config_name = 'two_obj_two_const_block'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--algorithm', type=str, default='HE_Cons_f_block', help='algorithm name')
    ...
    parser.add_argument('--ET_f1', type=float, default=0.5, help='Evaluation time for objective 1')
    ...
    # here index starts from 0 , in this example f2, g2 are in block [1,3]
    # another Example( not used here):
    #   [[1, 3], [0, 2, 4]]
    #   - Block 1: f2 and g2 → indices [1, 3]
    #   - Block 2: f1, g1, g3 → indices [0, 2, 4]
    parser.add_argument('--block_obj_cons', nargs="+",type=str, default='[[1,3]]', help='block_obj_cons first obj followed by cons')
    ...
    et_g1 = args.ET_g1
    et_g2 = args.ET_g2
    block_obj_cons = eval("".join(args.block_obj_cons))
    ...
    if algorithm == "batch":
        algorithm_batch = HECFB(heterogeneous=False,
    ...
    if algorithm == "HE_Cons_f_block":
        algorithm_pd_independent_et_dt_cf = HECFB(heterogeneous=True,
